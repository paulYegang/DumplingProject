...
@implementation RecuritInfoCell
...
-(void)setModels:(RecuritModel *)models{
    if (_models) {
        _models = models;
...
-(void) setUPUI{
//todo: 招聘职位
    _positionLable = [self createLabel:@"招聘私人法律顾问" fonts:[UIFont boldSystemFontOfSize:18] align:NSTextAlignmentLeft textcolor:[UIColor blackColor]];
    [_positionLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(@17);
    ...
    [man mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_positionLable.mas_bottom).offset(15);
        make.left.equalTo(@20);
...
//todo: 招募信息发布人
    _publishManLable = [self createLabel:@"饺子一号" fonts:[UIFont systemFontOfSize:15] align:NSTextAlignmentLeft textcolor:[UIColor grayColor]];
